...
const mess = {
   ...
   only: {
       ...
       owner: "`[ # ] Fitur Ini Cuma Bisa Di Akses Oleh Owner`",
       admin: "`[ # ] Fitur Ini Cuma Bisa Di Akses Oleh Aetmin`",
       badmin: ` \`[ # ] Gabisa, Mangkanya Bot ${namabot} Jadiin Aetmin\` `,
       premium: ` \`[ # ] Fitur Ini Cuma Bisa Di Akses Oleh Member Premium ${namabot}\` `,
   }
}
